...
This is a standalone version of the models that can be imported by Alembic without circular imports.
"""
...
class FamilyMember(Base):
    ...
    relationship = Column(String(50), nullable=False)  # spouse, child, parent, etc.
    date_of_birth = Column(DateTime, nullable=True)
    phone_number = Column(String(20), nullable=True)
...
# Create and connect to database (for testing)
if __name__ == "__main__":
    engine = create_engine("sqlite:///phrm_test.db")
